...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1442.6892242589174; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1340.7026255904013; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2583.0864213162013; // x position of the perpendicular encoder (in tick units)
    }
